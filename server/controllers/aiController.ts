...
--------------------------------------------------
3. SYSTEM-GENERATED OBSERVATIONS
--------------------------------------------------
...
*** End of Report ***`;
    ...
    // For simplicity of prototype download, we can send back standard JSON with the blob content
    // and frontend can handle the Blob download
